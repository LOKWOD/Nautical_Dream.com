...
if (publication20260903.length !== 3) throw new Error(`The 2026-09-03 publication must contain exactly three pages; found ${publication20260903.length}.`);
const slugs = new Set();
...
console.log("Built exactly three pages for the 2026-09-03 publication.");
