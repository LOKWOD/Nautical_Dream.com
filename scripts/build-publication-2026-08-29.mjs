...
if (publication20260829.length !== 2) throw new Error(`The 2026-08-29 publication must contain exactly two pages; found ${publication20260829.length}.`);
const slugs = new Set();
const titles = new Set();
for (const page of publication20260829) {
...
console.log("Built exactly two pages for the 2026-08-29 publication.");
