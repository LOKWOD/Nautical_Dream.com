...
<head>
  ...
  <meta property="og:image" content="https://nauticaldream.com/assets/editorial/newport-harbor.jpg"><meta property="og:image:width" content="1600"><meta property="og:image:height" content="900">
  <meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Nautical Dream Photography Credits"><meta name="twitter:description" content="Traceable sources and licenses for photography used across Nautical Dream."><meta name="twitter:image" content="https://nauticaldream.com/assets/editorial/newport-harbor.jpg">
  <link rel="alternate" type="application/rss+xml" title="Nautical Dream RSS" href="feed.xml"><link rel="manifest" href="site.webmanifest">
  <link rel="stylesheet" href="styles.css">
  <script type="application/ld+json">${JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://nauticaldream.com/"},{"@type":"ListItem","position":2,"name":"Image Credits"}]})}</script>
</head>
<body>
...
<main><nav class="seo-breadcrumbs shell" aria-label="Breadcrumb"><a href="index.html">Home</a><span aria-hidden="true">/</span><span aria-current="page">Image Credits</span></nav><section class="hero" style="--hero:url('assets/editorial/newport-harbor.jpg')"><div class="shell"><div class="eyebrow">Editorial record</div><h1>Image credits.</h1><p>Documentary photographs need a traceable source. Original illustrations need a clear creator and purpose.</p></div></section>
