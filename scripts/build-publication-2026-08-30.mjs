...
if (publication20260830.length !== 3) throw new Error(`The 2026-08-30 publication must contain exactly three pages; found ${publication20260830.length}.`);
const slugs = new Set();
...
console.log("Built exactly three pages for the 2026-08-30 publication.");
