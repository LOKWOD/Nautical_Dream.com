...
for (const htmlFile of htmlFiles) {
  ...
  if (dailyPage) {
    ...
    const heroPaths = {
      ...
      "boat-trailer-tongue-jack-photo-hero": "assets/editorial/boat-trailer-tongue-jack-photo-hero.webp",
      "great-sacandaga-family-planning-photo-hero": "assets/editorial/great-sacandaga-family-planning-photo-hero.webp",
      "boat-engine-stall-response-photo-hero": "assets/editorial/boat-engine-stall-response-photo-hero.webp",
      "boat-transom-straps-photo-hero": "assets/editorial/boat-transom-straps-photo-hero.webp",
      "otsego-lake-family-planning-photo-hero": "assets/editorial/otsego-lake-family-planning-photo-hero.webp",
      "boat-engine-overheat-response-photo-hero": "assets/editorial/boat-engine-overheat-response-photo-hero.webp",
      ...
      "boat-trailer-spare-system-photo-hero": "assets/editorial/boat-trailer-spare-system-photo-hero.webp",
    ...
    if (htmlFile === "boat-horn-sound-signal-guide.html") {
      const activeLinks = (html.match(/data-affiliate-active="true"/g) || []).length;
      if (activeLinks !== 3) problems.push(`${htmlFile}: expected exactly 3 active affiliate links; found ${activeLinks}`);
      if (!/As an Amazon Associate/i.test(html)) problems.push(`${htmlFile}: missing Amazon Associate disclosure`);
      if (/<a\b[^>]*data-commercial-link="true"[^>]*>\s*<img/i.test(html)) problems.push(`${htmlFile}: unverified affiliate product image found`);
    ...
    if (htmlFile === "canandaigua-lake-family-boating.html" && /data-affiliate-active="true"/.test(html)) {
      problems.push(`${htmlFile}: destination guide must not contain active affiliate links`);
    }
    if (htmlFile === "boat-navigation-lights-buying-guide.html") {
      const activeLinks = (html.match(/data-affiliate-active="true"/g) || []).length;
      if (activeLinks !== 4) problems.push(`${htmlFile}: expected exactly 4 active affiliate links; found ${activeLinks}`);
      if (!/As an Amazon Associate/i.test(html)) problems.push(`${htmlFile}: missing Amazon Associate disclosure`);
      if (/<a\b[^>]*data-commercial-link="true"[^>]*>\s*<img/i.test(html)) problems.push(`${htmlFile}: unverified affiliate product image found`);
      for (const match of html.matchAll(/<a\b([^>]*data-commercial-link="true"[^>]*)>/gi)) {
        const rel = match[1].match(/\brel="([^"]*)"/i)?.[1] || "";
    ...
    if (["boat-anchor-rode-buying-guide.html", "marine-carbon-monoxide-alarm-guide.html"].includes(htmlFile)) {
      const activeLinks = (html.match(/data-affiliate-active="true"/g) || []).length;
      if (activeLinks !== 3) problems.push(`${htmlFile}: expected exactly 3 active affiliate links; found ${activeLinks}`);
      if (!/As an Amazon Associate/i.test(html)) problems.push(`${htmlFile}: missing Amazon Associate disclosure`);
      if (/<a\b[^>]*data-commercial-link="true"[^>]*>\s*<img/i.test(html)) problems.push(`${htmlFile}: unverified affiliate product image found`);
    ...
    if (htmlFile === "fair-haven-little-sodus-bay-family-boating.html" && /data-affiliate-active="true"/.test(html)) {
      problems.push(`${htmlFile}: destination guide must not contain active affiliate links`);
    }
  }
}
