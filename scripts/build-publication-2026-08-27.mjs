...
if (publication20260827.length !== 2) {
  throw new Error(`The 2026-08-27 publication must contain exactly two pages; found ${publication20260827.length}.`);
}

const slugs = new Set();
const titles = new Set();
for (const page of publication20260827) {
...
console.log("Built exactly two pages for the 2026-08-27 publication.");
