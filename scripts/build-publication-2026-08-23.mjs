...
if (publication20260823.length !== 2) {
  throw new Error(`The 2026-08-23 publication must contain exactly two pages; found ${publication20260823.length}.`);
}
...
console.log("Built exactly two pages for the 2026-08-23 publication.");
