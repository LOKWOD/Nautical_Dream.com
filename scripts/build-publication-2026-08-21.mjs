...
if (publication20260821.length !== 2) {
  throw new Error(`The 2026-08-21 publication must contain exactly two pages; found ${publication20260821.length}.`);
}
...
console.log("Built exactly two pages for the 2026-08-21 publication.");
