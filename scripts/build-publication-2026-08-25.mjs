...
if (publication20260825.length !== 2) {
  throw new Error(`The 2026-08-25 publication must contain exactly two pages; found ${publication20260825.length}.`);
}

const slugs = new Set();
const titles = new Set();
for (const page of publication20260825) {
...
console.log("Built exactly two pages for the 2026-08-25 publication.");
