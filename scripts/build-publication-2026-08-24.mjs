...
if (publication20260824.length !== 2) {
  throw new Error(`The 2026-08-24 publication must contain exactly two pages; found ${publication20260824.length}.`);
}

const slugs = new Set();
const titles = new Set();
for (const page of publication20260824) {
...
console.log("Built exactly two pages for the 2026-08-24 publication.");
