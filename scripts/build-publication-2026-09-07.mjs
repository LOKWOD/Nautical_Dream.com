...
if (publication20260907.length !== 3) throw new Error(`The 2026-09-07 publication must contain exactly three pages; found ${publication20260907.length}.`);
const slugs = new Set();
...
console.log("Built exactly three pages for the 2026-09-07 publication.");
