...
updateFile("index.html", (html) => {
  if (html.includes('data-recent-library="2026-09-20"')) return html;
  const recent = `<section class="section" data-recent-library="2026-09-20"><div class="shell"><p class="lede"><strong>More recent field guides:</strong> <a href="boat-engine-cutoff-switch-lanyard-wireless-guide.html">engine-cutoff links</a>, <a href="schroon-lake-family-boating.html">Schroon Lake</a>, <a href="boat-runs-aground-response.html">the grounding response</a>, <a href="boat-trailer-security-coupler-wheel-lock-guide.html">trailer security layers</a>, <a href="saratoga-lake-family-boating.html">Saratoga Lake</a>, and <a href="used-boat-title-hin-paperwork-guide.html">the used-boat purchase gate</a>.</p></div></section>`;
